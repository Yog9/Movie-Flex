    ...
    return (
      <React.Fragment>
        ...
        <img className="cover-image"
          src={`${path}${imgSize}${this.props.moviedetails.backdrop_path}`}
          alt={this.props.moviedetails.original_title}
        />
        <div className="container">
          <div className="movies">

            <img className="poster" src={`${path}w154${this.props.moviedetails.poster_path}`} />
            <div className="moviedetails">
              <h2>{this.props.moviedetails.original_title}</h2>
              <div class="user-score">
                ...
                <div>{this.props.moviedetails.vote_average * 10} %</div>
              ...
              {/*<div className="genre-list">
                  ...
                  {this.props.moviedetails &&
                    this.props.moviedetails.genres.map(g =>
          ...
          <div className="main">
            ...
            <CastCarousel casts={this.props.moviecasts} />
            <div className="review">
              <h2>POPULAR REVIEW</h2>
              {/*{this.props.moviereviews.length ? <div className="review-container">{this.props.moviereviews}</div> :
                  <div className="review-empty"> NO REVIEWS FOUND :( </div>}*/}
            </div>
            <div className="similar-movie-list">
              <h2>SIMILAR MOVIES</h2>
              {console.log(this.props.similarMovies)}
              <SimilarMovies s_movies={this.props.similarMovies} />
            </div>
          </div>
        </div>
...
const mapStateToProps = state => ({
  ...
  similiarMovies: state.similiarMovies || [],
